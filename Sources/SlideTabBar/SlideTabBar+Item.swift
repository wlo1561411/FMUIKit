...
extension SlideTabBar {
    public class DefaultItem: UIView, SlideTabBarItem {
        ...
        fileprivate func applySettings(for status: ItemSetting.Status, settings: Settings) {
    ...
    public class TextOrImageItem: DefaultItem {
        private(set) var imageView = UIImageView()

        private var widthConstraint: Constraint?

        public init(imageWidth: CGFloat) {
            super.init()

            addSubview(imageView)
            imageView.snp.makeConstraints { make in
                make.edges.equalToSuperview()
                self.widthConstraint = make.width.equalTo(imageWidth).constraint
            }
        }
        ...
        override public func setSelected(_ isSelected: Bool, settings: SlideTabBar.DefaultItem.Settings) {
            super.setSelected(isSelected, settings: settings)
