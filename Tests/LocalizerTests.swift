...
final class LocalizationTests: XCTestCase {
    ...
    func testLocalizerWithArgumentsUpdates() {
        ...
        let localizer = Localizer(
            wrappedValue: UILabel(),
            makeContents: {
                $0.single("welcome", arguments: ["Finn"]).contents
            }
        )
    ...
    func testReplaceableLocalizerWithArgumentsReplaces() {
        ...
        let localizer = Localizer(
            ...
            mode: .replace,
            makeContents: {
                $0.single("greet", arguments: ["Finn"]).contents
            }
        )
    ...
    func testUIButtonReplaceableLocalizerWithArguments() {
        ...
        let localizer = Localizer(
            ...
            mode: .replace,
            makeContents: {
                $0.normal("welcome", arguments: ["Finn"]).contents
            }
        )
